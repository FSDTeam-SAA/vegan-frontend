...
import { OrganizationLiveStream } from "@/types/organization";
...
const OrganizationLiveStreamCard = ({
  data,
  loggedInUserId,
  paymentAdded,
}: Props) => {
  ...
  const handleBook = () => {
    ...
    if (!data?.organizationID) {
      toast.warning("Organization ID not found", {
        position: "top-right",
        richColors: true,
      });
      return;
...
export default OrganizationLiveStreamCard;
