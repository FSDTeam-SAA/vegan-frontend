...
export default function ContactSupportForm({
  ...
  const { isPending, mutate: createSupportTicket } = useMutation({
    mutationKey: ["create-professional-support"],
    mutationFn: (body: FormValues) =>
      fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/v1/professionalsupport`,
        {
          method: "POST",
          headers: {
    ...
    <div className="">
      <Form {...form}>
        <form
          ...
          className="max-h-[553px] min-w-[327px] max-w-[700px] space-y-4 rounded-lg bg-white px-[20px] py-[40px] shadow-lg md:px-[26px] lg:px-[32px]"
        >
